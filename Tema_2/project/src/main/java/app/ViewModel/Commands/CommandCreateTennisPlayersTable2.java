...
public class CommandCreateTennisPlayersTable2  implements ICommand {
    ...
    public CommandCreateTennisPlayersTable2() {
    }

    public CommandCreateTennisPlayersTable2(TennisMatchCRUDViewModel tennisMatchCRUDViewModel) {
    ...
    public void execute(Referee referee) {
        ...
        tennisMatchCRUDViewModel.setModelTennisPlayer2(defaultTableModel);
    }
}
